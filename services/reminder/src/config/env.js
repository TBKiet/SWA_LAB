...
const dbUrlVars = process.env.DATABASE_URL ? parseDbUrl(process.env.DATABASE_URL) : {};
...
module.exports = {
  ...
  DB_URL: process.env.DATABASE_URL || process.env.DB_URL || 'postgres://postgres:password@localhost:5432/reminderdb',
  DB_HOST: dbUrlVars.DB_HOST || process.env.DB_HOST || 'localhost',
  DB_PORT: dbUrlVars.DB_PORT || parseInt(process.env.DB_PORT) || 5432,
  DB_NAME: dbUrlVars.DB_NAME || process.env.DB_NAME || 'reminderdb',
  DB_USER: dbUrlVars.DB_USER || process.env.DB_USER || 'postgres',
  DB_PASSWORD: dbUrlVars.DB_PASSWORD || process.env.DB_PASSWORD || 'password',
